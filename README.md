...
A Relational Database Management System is the software used to manage relational databases, whereas SQL is the querying language used to interact with tables/data in the database.

1. Why do tables need a `primary key`?

IDs allow each row in the table to have a unique identifier. Having primary keys makes it easier to join tables.
